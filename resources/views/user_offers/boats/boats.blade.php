                ...
                <div class="col-8 offset-2">
                    ...
                    <div class="form-group row">
                        ...
                        <input id="boat_cost_of_renting"
                               ...
                               value="{{old('boat_cost_of_renting') }}"
                               autocomplete="">
                    ...
                    <div class="row pt-4">
                        <button class="btn btn-primary ">Submit your boat</button>
                    </div>
                </div>
            </div>
        </form>
