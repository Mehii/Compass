...
@section('content')
    ...
    <div class="section">
        <form action="/{{app()->getLocale()}}/myprofile/items/boat/{{$boat->id}}" enctype="multipart/form-data" method="POST" id="name_of_the_city">
            @csrf
            @method('PATCH')
            <div class="container">
                <div class="row">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-3 col-xl-2">
                        <label for="boat_type" class="col-md-4 col-form-label text-md-left">{{__('Boat Type')}}</label>
                        <div class="form-group">
                            <select id="boat_type" name="boat_type" class="form-control">
                                <option value="Fishing_Boats">{{__('Fishing Boats')}}</option>
                                <option value="Sail_Boat">{{__('Sailboat')}}</option>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-md-3 col-xl-2">
                        <div class="form-group" style="width: 100px">
                            ...
                            <input type='checkbox'
                                   id="checkbox"
                                   name="heating" value="1" autocomplete="0">
                            @error('heating')
                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
            ...
            <div class="container">
                ...
                <div class="col-md-6">
                    <button class="btn btn-primary align-bottom">{{__('Edit your boat details')}}</button>
                </div>
            </div>
        </form>
    </div>
